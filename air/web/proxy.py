...
url = 'https://free-proxy-list.net/' #prob full of comp aids?

#cc = country code, anon = anonymous proxy, google = google recognised, last_checked = last time it had a successful connection
...
class AssociatedAccounts: #shady
