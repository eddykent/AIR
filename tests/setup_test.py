...
from setups.simple_setups import ForexSignalsAnchorBar, MACD_EMA_SR, FastRSI, MeanReversionFFXS
...
fsab = ForexSignalsAnchorBar(instruments)
signals = fsab.get_setups(start_date,end_date)
