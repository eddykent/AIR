...
backtest_result = cc.apply_bounds(backtest_result,nlb=50,nhb=0,ratio=0.5,streak_diff=False)
backtest_result = backtest_result.sort_values(by=['ratio'],ascending=False).head(500) #selects loads of 1-hits
...
original, filtered, cm = try_suggestion(suggestion)
print(original)
print(filtered)
print(cm)
