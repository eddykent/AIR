...
from air.setups.setup_tools import PipStop, ATRStop
...
from air.backtest import BackTesterDatabase, BackTestStatistics, BackTesterCandles
from air.filters.simple_filters import LambdaSelectFilter

from air.charting.chart_viewer import PlotlyChartPainter
lfr = ListFileReader()
