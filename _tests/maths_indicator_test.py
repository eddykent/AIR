...
from air.indicators.mathematic import *
from air.indicators.volatility import ChoppinessIndex
...
#OurIndicator = FourierGradient #promising
#OurIndicator = ChoppinessIndex
#OurIndicator = CorrelationAnalysis #doesnt exist yet
...
def draw_charts(ii):
	for i in range(4):
		...
		result_bias = bullish[i,ii].astype(int) - bearish[i,ii].astype(int)
