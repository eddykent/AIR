...
from air.utils import Configuration, ListFileReader
from air.charting.chart_pattern import * #grab all patterns 
from air.charting.trend_pattern import * #grab all advanced patterns too 
...
the_date = datetime.datetime(2022,2,23,8,0)
