...
from air.charting.candle_stick_pattern import * #grab all patterns 
import air.charting.chart_viewer as chv



#from air.trade_schedule import TradeSchedule #waht is this
from air.utils import ListFileReader, TimeZipper
