...
WITH candle_indexs AS (
	...
	AND the_date < (DATE '24 Jan 2022' + INTERVAL '12 hours')
	AND the_date >= (DATE '24 Jan 2022' - INTERVAL '200 days' + INTERVAL '12 hours') --600 = 400 + 200 (days_back + normalisation_window)
),
