...
CREATE OR REPLACE FUNCTION trading.get_partial_candles_volumes_from_currencies(_currencies TEXT[], _trade_times TIMESTAMP[], _chart_resolution INTEGER DEFAULT 15, _candle_offset INTEGER DEFAULT 0)
RETURNS TABLE (
	row_index INTEGER,	
	from_currency TEXT,
	to_currency TEXT,
...
COMMENT ON FUNCTION trading.get_partial_candles_volumes_from_currencies(TEXT[], TIMESTAMP[], int, int) IS 'From a set of currencies and candle end times, get the associated forex partial candles and volumes';
