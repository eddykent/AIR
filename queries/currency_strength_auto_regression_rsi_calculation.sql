...
collected_strengths AS (
	...
	SUM(CASE WHEN ABS(correlation) > 0.25 THEN (slope*strength2_leadlag+intercept) ELSE 0 END) AS sum_next_strengths,
	SUM(CASE WHEN ABS(correlation) > 0.25 THEN (slope*strength2_leadlag+intercept)*(slope*strength2_leadlag+intercept) ELSE 0 END) AS sum_squared_next_strengths,
	SUM(CASE WHEN ABS(correlation) > 0.25 THEN 1 ELSE 0 END) AS n_next_strengths
