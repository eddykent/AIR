...
#gru = reshape2 #cat
gru = cat
#gru = keras.layers.GRU(64,return_sequences=True)(gru)
#gru = keras.layers.Dropout(0.1)(gru)
gru = keras.layers.GRU(110,return_sequences=False,activity_regularizer=l2_reg)(gru)
dense = gru
dense = keras.layers.Dropout(0.3)(dense)

dense = keras.layers.Dense(100,activation='sigmoid',activity_regularizer=l2_reg)(dense)
dense = keras.layers.Dropout(0.3)(dense)

dense = keras.layers.Dense(64,activation='sigmoid',activity_regularizer=l2_reg)(dense)
dense = keras.layers.Dropout(0.3)(dense)

dense = keras.layers.Dense(32,activation='sigmoid',activity_regularizer=l2_reg)(dense)
...
model.compile(loss=ranking_loss,optimizer=opt)
